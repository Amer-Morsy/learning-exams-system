<template>
  <div class="row custom-cards" v-if="questionBanksData.length">
    <CustomCard
      v-for="(questionBank, index) in questionBanksData"
      :key="index"
      :className="'col-sm-6 col-md-4 col-lg-3'"
      :title="questionBank.questionBankNameCurrent"
      :description="questionBank.fullCode"
      :imagePath="questionBank.questionBankImagePath"
